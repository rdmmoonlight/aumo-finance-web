...
export default function GuardianSecurityPage() {
  ...
  useEffect(() => {
    const fetchGuardianData = async () => {
      try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/v1/api/v1/guardian`, {
          method: 'GET',
          headers: {
  ...
  const handleRevokeSession = async (sessionId?: string, deviceName?: string) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/v1/api/v1/guardian/revoke-session/${sessionId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleRevokeAllSessions = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/v1/api/v1/guardian/revoke-all`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
