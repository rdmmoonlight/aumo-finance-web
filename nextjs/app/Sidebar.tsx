        ...
        <div id="reports-flyout" className="sidebar-flyout">
          ...
          <div className="list-group list-group-flush p-2 small">
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/general-ledger' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/general-ledger/true' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/trial-balance' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
              Trial Balance
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/trial-balance/true' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/post-closing-trial-balance' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
              Post-Closing TB
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action py-2 px-3 rounded mb-1 ${
                pathname === '/reports/cash-flow' ? 'active' : ''
              }`}
              onClick={closeFlyout}
            >
              Cash Flow
