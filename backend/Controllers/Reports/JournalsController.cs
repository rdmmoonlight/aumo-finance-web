...
public class JournalsController : ControllerBase
{
    ...
    // ==========================================
    // 1. GET: /api/v1/reports/journals/general
    // ==========================================
    [HttpGet("general")]
    ...
    // ==========================================
    // 2. GET: /api/v1/reports/journals/adjusting
    // ==========================================
    [HttpGet("adjusting")]
    ...
    // ==========================================
    // 3. DELETE: /api/v1/reports/journals/adjusting/{id}
    // ==========================================
    ...
    // ==========================================
    // 4. GET: /api/v1/reports/journals/closing
    // ==========================================
    [HttpGet("closing")]
    public async Task<IActionResult> GetClosingJournal()
    {
        ...
        var groups = new List<ClosingJournalEntryGroupResponse>();
        ...
        if (incomeRows.Any())
        {
            var group1 = new ClosingJournalEntryGroupResponse { Description = "Closing Revenue Accounts to Income Summary" };
            foreach (var r in incomeRows)
            {
                group1.Lines.Add(new ClosingJournalLineResponse
                {
        ...
        if (expenseRows.Any())
        {
            var group2 = new ClosingJournalEntryGroupResponse { Description = "Closing Expense Accounts to Income Summary" };
            group2.Lines.Add(new ClosingJournalLineResponse
            {
                ReferenceNumber = 0,
                AccountName = incomeSummaryName,
        ...
        {
            var group3 = new ClosingJournalEntryGroupResponse { Description = "Closing Income Summary to Retained Earnings" };

            if (incomeStatement.NetIncome > 0)
            {
                group3.Lines.Add(new ClosingJournalLineResponse
                {
                    ReferenceNumber = 0,
                    AccountName = incomeSummaryName,
...
public class ClosingJournalEntryGroupResponse
{
    public string Description { get; set; } = string.Empty;
    public List<ClosingJournalLineResponse> Lines { get; set; } = new();
    public decimal TotalDebit => Lines.Sum(l => l.Debit);
    public decimal TotalCredit => Lines.Sum(l => l.Credit);
}

public class ClosingJournalLineResponse
{
