...
export default function PostClosingTrialBalanceReportPage() {
  ...
  const fetchReportData = useCallback(async () => {
    ...
    try {
      ...
      const response = await apiClient.get(`${API_BASE_URL}/api/v1/reports/statement-of-financial-position?isPostClosing=true`, {
        method: 'GET',
    ...
    <div className="container-fluid py-4 px-4 text-white">
      ...
      {noPeriodSelected ? (
        ...
        <div className="text-center py-5 my-4">
          ...
          <Link to="/periods" className="btn btn-primary btn-sm fw-semibold shadow-sm px-4 d-inline-flex align-items-center">
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div className="d-flex gap-2">
              <Link to="/reports/trial-balance/adjusted" className="btn btn-outline-secondary fw-semibold shadow-sm d-inline-flex align-items-center">
                <i className="ti ti-list-check me-1"></i> Adjusted TB
              </Link>
              <Link to="/reports/cash-flow" className="btn btn-outline-secondary fw-semibold shadow-sm d-inline-flex align-items-center">
