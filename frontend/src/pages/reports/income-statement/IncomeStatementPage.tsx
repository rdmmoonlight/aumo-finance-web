...
export default function IncomeStatementReportPage() {
  ...
  const fetchIncomeStatementData = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`${API_BASE_URL}/api/v1/reports/income-statement`, {
        method: 'GET',
      ...
      {noPeriodSelected ? (
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div>
              <Link to="/reports/retained-earnings" className="btn btn-outline-secondary fw-semibold shadow-sm d-inline-flex align-items-center">
