    ...
    <div className="container-fluid py-4 px-4 text-white" style={{ fontFamily: 'Aptos, sans-serif' }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div className="d-flex gap-2">
          <Link to="/adjusting-journal-entry" className="btn btn-primary fw-bold shadow-sm d-inline-flex align-items-center">
                              ...
                              <div className="d-flex flex-column align-items-start mt-1">
                                ...
                                {editMode && (
                                  <div className="d-flex gap-1 mt-1">
                                    <Link to={`/adjusting-journal-entry?id=${entry.id}`}
