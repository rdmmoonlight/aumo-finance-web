...
export default function WorksheetReportPage() {
  ...
  const fetchWorksheetData = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`${API_BASE_URL}/api/v1/reports/worksheet`, {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
        withCredentials: true, // Menggunakan Session Cookie
      });
      ...
      {noPeriodSelected ? (
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div>
              <Link to="/reports/income-statement" className="btn btn-outline-secondary fw-semibold shadow-sm d-inline-flex align-items-center">
