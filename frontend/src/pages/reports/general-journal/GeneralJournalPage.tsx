    ...
    <div className="container-fluid py-4 px-4 text-white">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <div className="d-flex gap-2">
          <Link to="/journal-entry" className="btn btn-primary fw-semibold shadow-sm d-inline-flex align-items-center">
                      ...
                      {selectedPeriodName === null ? (
                        <div className="py-3">
                          ...
                          <p className="mb-0 small text-white-50">
                            Go to{' '}
                            <Link to="/periods" className="text-decoration-none fw-bold text-primary">
                              Periods
                            </Link>{' '}
                            to select one.
                          </p>
